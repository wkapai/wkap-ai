    ...
    with transaction.atomic():
        packet, _ = DailyWoWPacket.objects.update_or_create(
            ...
            defaults={
                ...
                "packet_id": parsed.packet_id or f"WKAP-{investor.investor_id}-{parsed.market_date}",
                "author_id": investor.investor_id,
                ...
                "raw_packet_json": {**parsed.raw_packet_json, "author_id": investor.investor_id},
                "agent_facts_json": {**parsed.agent_facts_json, "author_id": investor.investor_id},
                "validation_results_json": parsed.validation_results_json,
                "wow_items_json": parsed.wow_items_json,
