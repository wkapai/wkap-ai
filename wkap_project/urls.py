...
urlpatterns = [
    ...
    path("specs/wow-crm-v0.1.json", views.json_resource, {"resource_key": "wow_crm_v0_1"}, name="wow_crm_spec_v0_1"),
    path("specs/wow-intake-flow-v0.1.json", views.json_resource, {"resource_key": "wow_intake_flow_v0_1"}, name="wow_intake_flow_v0_1"),
    path("specs/daily-wow-state-v0.1.schema.json", views.json_resource, {"resource_key": "daily_wow_state_v0_1"}, name="daily_wow_state_schema_v0_1"),
    ...
    path("specs/wow-crm-latest.json", views.markdown_latest_redirect, {"target_path": "/specs/wow-crm-v0.1.json"}, name="wow_crm_spec_latest"),
    path("specs/wow-intake-flow-latest.json", views.markdown_latest_redirect, {"target_path": "/specs/wow-intake-flow-v0.1.json"}, name="wow_intake_flow_latest"),
    path("specs/daily-wow-state-latest.schema.json", views.markdown_latest_redirect, {"target_path": "/specs/daily-wow-state-v0.1.schema.json"}, name="daily_wow_state_schema_latest"),
